...
export class PersonCreateDto {
    // Identification
    @ApiModelPropertyOptional({ enum: Object.keys(IdentityDocumentType), example: IdentityDocumentType.DriverLicense })
    ...
    @ApiModelPropertyOptional({ type: 'string', format: 'date', example: new Date() })
    @IsDateString()
    @IsOptional()
