import { Controller, Get, Post, ValidationPipe, Body, Param, Put, Delete } from '@nestjs/common';
import { ActorsService } from './actors.service';
import { ApiOperation, ApiResponse, ApiCreatedResponse, ApiBadRequestResponse, ApiOkResponse, ApiNotFoundResponse, ApiUseTags } from '@nestjs/swagger';
